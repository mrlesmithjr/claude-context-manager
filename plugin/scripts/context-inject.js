...
function markVersionActivated() {
  try {
    ...
    writeFileSync(PLUGIN_VERSION_FILE, "0.8.109", "utf-8");
  } catch {
  }
}
...
async function main() {
  ...
  try {
    ...
    lines.push(`context-manager v${"0.8.109"} active. ${count} observations tracked.${branchHint}`);
